...
def bootstrap_admin_permissions() -> None:
    ...
    defaults = [
        ...
        ("menu:users:blacklist", "黑名单管理", "menu", "/users/blacklist", "menu:users"),
        ...
        ("button:user:blacklist:manage", "黑名单管理", "button", "", "menu:users:blacklist"),
        ...
        ("menu:hospital_care", "医院管理", "menu", "/hospital-care", ""),
        ("menu:hospital_care:hospitals", "医院列表", "menu", "/hospital-care/hospitals", "menu:hospital_care"),
        ("button:hospital_care:hospital:create", "新增医院", "button", "", "menu:hospital_care:hospitals"),
        ("button:hospital_care:hospital:update", "编辑医院", "button", "", "menu:hospital_care:hospitals"),
        ("button:hospital_care:hospital:activate", "启用医院", "button", "", "menu:hospital_care:hospitals"),
        ("button:hospital_care:hospital:suspend", "暂停医院", "button", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:hospital:list", "医院列表", "api", "/api/admin/v1/hospital-care/hospitals/", "menu:hospital_care:hospitals"),
        ("api:hospital_care:hospital:read", "医院详情", "api", "/api/admin/v1/hospital-care/hospitals/", "menu:hospital_care:hospitals"),
        ("api:hospital_care:hospital:create", "创建医院", "api", "/api/admin/v1/hospital-care/hospitals/", "menu:hospital_care:hospitals"),
        ("api:hospital_care:hospital:update", "更新医院", "api", "/api/admin/v1/hospital-care/hospitals/", "menu:hospital_care:hospitals"),
        ("api:hospital_care:hospital:activate", "启用医院", "api", "/api/admin/v1/hospital-care/hospitals/", "menu:hospital_care:hospitals"),
        ("api:hospital_care:hospital:suspend", "暂停医院", "api", "/api/admin/v1/hospital-care/hospitals/", "menu:hospital_care:hospitals"),
        ("api:hospital_care:department:list", "科室列表", "api", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:department:create", "新增科室", "api", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:department:update", "更新科室", "api", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:staff:list", "职工列表", "api", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:staff:create", "邀请职工", "api", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:staff:update", "更新职工", "api", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:doctor:list", "医生列表", "api", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:doctor:update", "更新医生", "api", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:agent:list", "智能体列表", "api", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:agent:read", "智能体详情", "api", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:agent:create", "创建智能体", "api", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:agent:update", "维护智能体", "api", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:agent:review", "审核智能体", "api", "", "menu:hospital_care:hospitals"),
        ("button:hospital_care:agent:create", "新建智能体", "button", "", "menu:hospital_care:hospitals"),
        ("button:hospital_care:agent:update", "维护智能体", "button", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:knowledge:list", "知识库列表", "api", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:knowledge:read", "知识库详情", "api", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:knowledge:create", "创建知识库", "api", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:knowledge:update", "更新知识库", "api", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:knowledge:delete", "删除知识库", "api", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:knowledge:document_create", "新增知识文本", "api", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:knowledge:document_update", "编辑知识文本", "api", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:knowledge:document_delete", "删除知识文本", "api", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:knowledge:vector_build", "生成知识向量", "api", "", "menu:hospital_care:hospitals"),
        ("button:hospital_care:knowledge:create", "新建知识库", "button", "", "menu:hospital_care:hospitals"),
        ("button:hospital_care:knowledge:update", "维护知识库", "button", "", "menu:hospital_care:hospitals"),
        ("button:hospital_care:knowledge:delete", "删除知识库", "button", "", "menu:hospital_care:hospitals"),
        ("button:hospital_care:knowledge:vector_build", "生成知识向量", "button", "", "menu:hospital_care:hospitals"),
        ("api:hospital_care:audit:list", "医院审计", "api", "", "menu:hospital_care:hospitals"),
    ]
