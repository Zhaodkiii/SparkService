...
from backoffice.views import (
    ...
    AdminAIScenarioDetailView,
    AdminAIScenarioListView,
...
urlpatterns = [
    ...
    path("ai/scenarios/", AdminAIScenarioListView.as_view(), name="admin-ai-scenario-list"),
    path("ai/scenarios/<int:scenario_id>/", AdminAIScenarioDetailView.as_view(), name="admin-ai-scenario-detail"),
