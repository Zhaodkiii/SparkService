...
from backoffice.views import (
    ...
    AdminUserDetailView,
    AdminIdentityScopeOptionsView,
    AdminUserAuthIdentityCreateView,
    AdminUserAuthIdentityDetailView,
    AdminUserListView,
...
urlpatterns = [
    ...
    path("users/identity-scopes/", AdminIdentityScopeOptionsView.as_view(), name="admin-identity-scope-options"),
    ...
    path("users/<int:user_id>/auth-identities/", AdminUserAuthIdentityCreateView.as_view(), name="admin-user-auth-identity-create"),
    path(
        "users/<int:user_id>/auth-identities/<int:identity_id>/",
        AdminUserAuthIdentityDetailView.as_view(),
        name="admin-user-auth-identity-detail",
    ),
