...
import { HealthResourceCandidateCardsBlock, LocationPermissionCardsBlock, PendingMemberToolCardsBlock, SmallTaskCardBlock, SymptomCollectionCardBlock, TaskCardsBlock, ToolConsentCardsBlock, ToolMemberSelectionCardsBlock, ToolQuestionCardsBlock } from "@/components/chat/blocks/TaskBlocks";
...
export const BLOCK_RENDERERS: Record<string, BlockRenderer> = {
  ...
  symptomCollectionCard: SymptomCollectionCardBlock,
