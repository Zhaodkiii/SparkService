...
from hospital_care.realtime.routing import websocket_urlpatterns as hospital_websocket_urlpatterns

websocket_urlpatterns = [
    path("ws/chat/sync/", ChatSyncConsumer.as_asgi()),
] + ai_websocket_urlpatterns + hospital_websocket_urlpatterns
