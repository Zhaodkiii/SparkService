...
class ChatRemoteThreadSerializer(serializers.Serializer):
    ...
    icon_color_name = serializers.CharField(required=False, allow_blank=True, allow_null=True)
    is_pinned = serializers.BooleanField(required=False, default=False)
    pinned_at = serializers.DateTimeField(required=False, allow_null=True)
